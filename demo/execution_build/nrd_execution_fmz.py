...
# Deribit S:PM 日历保护型卖方执行链 v1.6.2（FMZ 单文件；含 VRP门/执行会话/缺口域/对冲整合层）
...
#   计划轮 ROUND_MODE="PLAN"：枚举所有符合范围的备选(垂直+日历)，按 胜率/盈亏比/信号 筛选排序，
        ...
        for short in legsel_short_enriched(s_insts, spot, want_call, delta_fn):
            ...
            for mode, prot, p_dte_h in specs:
                ...
                c = plan_assemble(mode, ORDER_AMOUNT, spot, MIN_MARGIN_RELIEF_RATIO,
                                  PROTECTION_RESIDUAL_RECOVERY, pref,
                                  want_call, short, sq, prot, pq,
