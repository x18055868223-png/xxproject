...
def main():
    ...
    for root in roots:
        ...
        assert_true(gamma_idx != -1 and rank_idx != -1 and durability_idx != -1,
                    "renderDocument should call gamma, rank, and durability sections")
        assert_true(gamma_idx < rank_idx < durability_idx,
                    "rank section should render after Gamma/GEX and before durability context")
