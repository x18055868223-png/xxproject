...
- The deploy signal-audit frontend baseline is r3.1 as of 2026-06-23: compact EDB evidence ledger, `source_ref` anchors back to raw trace groups, raw trace grouped navigation, and production/default materializer output excluding synthetic/local preview cards.
